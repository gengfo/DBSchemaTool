 ...
 */
public class DBSchemaForPasMsSql {

	String connectionURL = "jdbc:sqlserver://bh;databaseName=pasuat;integratedSecurity=false";

	String driverClass = "com.microsoft.sqlserver.jdbc.SQLServerDriver";

	String userID = "pasuat";

	String userPassword = "pasuat";

	Connection con = null;

	public DBSchemaForPasMsSql() {
	...
	// DbColumn newColumn = new DbColumn(columnName, datatype, datasize, digits,
	// isNull); table.addColumn(newColumn); }
	// }
	...
	public void writeTablesToExcel() throws SQLException, BiffException,
		...
		WritableWorkbook workbook = Workbook
				.createWorkbook(new File(
						"C:\\Documents and Settings\\gengfo\\Desktop\\ToCheck\\PASDBSchema.xls"));
		...
		for (int j = 0; j < tableList.size(); j++) {
			...
			ResultSet tableSchemas = md.getColumns("PASUAT", "%", tableName,
					"%");
	...
	public List readTables() throws SQLException {
		...
		md = con.getMetaData();
		String[] names = { "TABLE" };
		ResultSet tableNames = md.getTables(null, "%", "%", names);
		while (tableNames.next()) {
	...
	public static void main(String[] args)
		...
		DBSchemaForPasMsSql dmde = new DBSchemaForPasMsSql();
