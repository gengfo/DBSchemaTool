...
public class GenerateDBSchema {
	...
	// "jdbc:oracle:thin:@shasudv6:1521:TMSDB";
	//    
	// final static String connectionURL =
	// "jdbc:oracle:thin:@shasudv7:1521:ivodb";
	//    
	...
	final static String connectionURL = "jdbc:oracle:thin:@iptiuat:1521:iptiprd";

	final static String userID = "dssowner";

	final static String userPassword = "prdowner";
	...
	public void writeTablesToExcel() throws SQLException, BiffException,
		...
		WritableWorkbook workbook = Workbook
				.createWorkbook(new File("DSDBSchema.xls"));
	...
	public List readTables() throws SQLException {
		...
		md = con.getMetaData();
		String[] names = { "TABLE" };
		ResultSet tableNames = md.getTables(null, "DSSOWNER", "%", names);
	...
	public static void main(String[] args)
		...
		GenerateDBSchema dmde = new GenerateDBSchema();
		dmde.writeTablesToExcel();
		System.out.println("Write out done!");
		// dmde.runExample();
		// dmde.readTableSchema();
		// dmde.readTables();
		// dmde.readCatalogs();
